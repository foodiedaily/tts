...
if (have_posts()) while (have_posts()) :
    ...
    $recipe_featured_product = $recipe_obj->get_featured_product();
    $recipe_video = $recipe_obj->get_video();
    ...
    <div class="row">
        <div itemscope itemtype="http://schema.org/Recipe" <?php post_class(); ?>>
            ...
            <section class="content three-fourth">
                ...
                <article id="recipe-<?php the_ID(); ?>" class="recipe">
                    <div class="row">
                        ...
                        <div class="one-third entry-header">
                            <dl class="basic">
                                <div class="featured_product">
                                    <?php if ($recipe_featured_product) { ?>
                                ...
                                <?php if ($recipe_preparation_time) { ?>
                                    ...
                                    <dd itemprop="prepTime"
                                        content="<?php echo $mf_recipe_preparation_time; ?>"><?php echo $recipe_preparation_time; ?><?php _e('mins', 'socialchef'); ?></dd>
                                <?php } ?>
                                <?php if ($recipe_cooking_time) { ?>
                                    <dt><?php _e('Cooking time', 'socialchef'); ?></dt>
                                    <dd itemprop="cookTime"
                                        content="<?php echo $mf_recipe_cooking_time; ?>"><?php echo $recipe_cooking_time; ?><?php _e('mins', 'socialchef'); ?></dd>
                                <?php } ?>
                                <?php if ($recipe_difficulty) {
                                    ...
                                    <dd>
                                        <a href="<?php echo esc_url($difficulty_link); ?>"><?php echo $recipe_difficulty->name; ?></a>
                                    </dd>
                                <?php } ?>
                            ...
                            <dl class="user">
                                <?php if ($recipe_meal_course) { ?>
                                    ...
                                    <dd>
                                        <a href="<?php echo esc_url(get_term_link($recipe_meal_course->term_id, 'recipe_meal_course')); ?>"><?php echo $recipe_meal_course->name; ?></a>
                                    </dd>
                                <?php } ?>
                                <dt><?php _e('Posted by', 'socialchef'); ?></dt>
                                <dd itemprop="author" class="vcard author post-author"><span class="fn"><a
                                            href="<?php echo esc_url($author_uri); ?>"><?php echo $author_nice_name; ?></a></span>
                                </dd>
                                <dt><?php _e('Posted on', 'socialchef'); ?></dt>
                                <dd itemprop="datePublished" content="<?php echo get_the_date(); ?>"
                                    ...
                                    <div class="favorite">
                                        ...
                                        if ($sc_recipes_post_type->is_marked_as_favorite($current_user->ID, $post->ID)) {
                                            ...
                                            <a href="javascript:void(0);" class="remove"><i
                                                    class="ico eldorado_heart"></i>
                                                <span><?php _e('Remove from favorites', 'socialchef'); ?></span></a>
                                            <?php
                                        } else { ?>
                                            <a href="javascript:void(0);"><i class="ico eldorado_heart"></i>
                                                <span><?php _e('Add to favorites', 'socialchef'); ?></span></a>
                                        <?php } ?>
                                    </div>
                                <?php } else { ?>
                                    <div class="favorite">
                                        <a class="disabled"
                                           href="<?php echo esc_url($sc_theme_globals->get_login_page_url()); ?>"><i
                                                class="ico eldorado_heart"></i>
                                            <span><?php _e('Add to favorites', 'socialchef'); ?></span></a>
                                    </div>
                                <?php } ?>
                        ...
                        <div class="two-third">
                            ...
                            if (!empty($main_image)) { ?>
                                <div class="image"><img itemprop="image" src="<?php echo esc_url($main_image) ?>"
                ...
                <!--//recipe-->
                <?php $reply=$_GET['replytocom'];
                if($reply) {
                    comments_template('/comments.php', true);
                } else {
                    comments_template('/short-comments.php', true);
                } ?>
                <!--//recipe entry-->
            </section>
