	...
	<header id="headID" class="head headHide" role="banner">
		...
		<div class="wrap clearfix">
			...
			<nav class="user-nav" role="navigation">
				<ul>
					<li class="light"><a href="<?php echo esc_url ($sc_theme_globals->get_search_form_page_url() ); ?>" title="<?php _e('Search for recipes', 'socialchef'); ?>"><i class="ico eldorado_search"></i> <span><?php _e('Search for recipes', 'socialchef'); ?></span></a></li>
					<li class="medium"><a href="<?php echo is_user_logged_in() ? esc_url ( $account_uri ) : esc_url ( $sc_theme_globals->get_login_page_url() ); ?>" title="<?php _e('My account', 'socialchef'); ?>"><i class="ico eldorado_user"></i> <span><?php _e('My account', 'socialchef'); ?></span></a></li>
					<li class="dark"><a href="<?php echo is_user_logged_in() ? esc_url ( $sc_theme_globals->get_submit_recipes_url() ) : esc_url ( $sc_theme_globals->get_login_page_url() ); ?>" title="<?php _e('Submit a recipe', 'socialchef'); ?>"><i class="ico eldorado_fork_2"></i> <span><?php _e('Submit a recipe', 'socialchef'); ?></span></a></li>
				</ul>
			</nav>
		</div>
		<!--//wrap-->
