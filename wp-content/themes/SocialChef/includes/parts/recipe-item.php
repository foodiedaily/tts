...
if (!empty( $main_image ) ) { ?>
	<figure>
		...
		<figcaption><a href="<?php echo esc_url ( $recipe_obj->get_permalink() ); ?>"><i class="ico eldorado_eyelash"></i> <span><?php _e('View recipe', 'socialchef'); ?></span></a></figcaption>
	</figure>
<?php } ?>
	<div class="container">
		<h2>
		...
		<div class="actions">
			<div>
				...
				<div class="comments"><i class="ico eldorado_comment_baloon"></i><a href="<?php echo esc_url ($recipe_obj->get_permalink() ); ?>#comments"><?php echo $recipe_comments; ?></a></div>
			</div>
		</div>
	</div>
</div>
