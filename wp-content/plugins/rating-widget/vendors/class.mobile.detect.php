...
class Mobile_Detect
{
    ...
    public function mobileGrade()
    {
        ...
        if ( $this->version( 'iPad', self::VERSION_TYPE_FLOAT ) >= 4.3 || $this->version( 'iPhone', self::VERSION_TYPE_FLOAT ) >= 3.1 || $this->version( 'iPod', self::VERSION_TYPE_FLOAT ) >= 3.1 || $this->version( 'Android', self::VERSION_TYPE_FLOAT ) > 2.1 && $this->is( 'Webkit' ) || $this->version( 'Windows Phone OS', self::VERSION_TYPE_FLOAT ) >= 7.0 || $this->is( 'BlackBerry' ) && $this->version( 'BlackBerry', self::VERSION_TYPE_FLOAT ) >= 6.0 || $this->match( 'Playbook.*Tablet' ) || $this->version( 'webOS', self::VERSION_TYPE_FLOAT ) >= 1.4 && $this->match( 'Palm|Pre|Pixi' ) || $this->match( 'hp.*TouchPad' ) || $this->is( 'Firefox' ) && $this->version( 'Firefox', self::VERSION_TYPE_FLOAT ) >= 12 || $this->is( 'Chrome' ) && $this->is( 'AndroidOS' ) && $this->version( 'Android', self::VERSION_TYPE_FLOAT ) >= 4.0 || $this->is( 'Skyfire' ) && $this->version( 'Skyfire', self::VERSION_TYPE_FLOAT ) >= 4.1 && $this->is( 'AndroidOS' ) && $this->version( 'Android', self::VERSION_TYPE_FLOAT ) >= 2.3 || $this->is( 'Opera' ) && $this->version( 'Opera Mobi', self::VERSION_TYPE_FLOAT ) > 11 && $this->is( 'AndroidOS' ) || $this->is( 'MeeGoOS' ) || $this->is( 'Tizen' ) || $this->is( 'Dolfin' ) && $this->version( 'Bada', self::VERSION_TYPE_FLOAT ) >= 2.0 || ($this->is( 'UC Browser' ) || $this->is( 'Dolfin' )) && $this->version( 'Android', self::VERSION_TYPE_FLOAT ) >= 2.3 || ($this->match( 'Kindle Fire' ) || $this->is( 'Kindle' ) && $this->version( 'Kindle', self::VERSION_TYPE_FLOAT ) >= 3.0) || $this->is( 'AndroidOS' ) && $this->is( 'NookTablet' ) || $this->version( 'Chrome', self::VERSION_TYPE_FLOAT ) >= 11 && !$isMobile || $this->version( 'Safari', self::VERSION_TYPE_FLOAT ) >= 5.0 && !$isMobile || $this->version( 'Firefox', self::VERSION_TYPE_FLOAT ) >= 4.0 && !$isMobile || $this->version( 'MSIE', self::VERSION_TYPE_FLOAT ) >= 7.0 && !$isMobile || $this->version( 'Opera', self::VERSION_TYPE_FLOAT ) >= 10 && !$isMobile ) {
            return self::MOBILE_GRADE_A;
        }
        if ( $this->version( 'iPad', self::VERSION_TYPE_FLOAT ) < 4.3 || $this->version( 'iPhone', self::VERSION_TYPE_FLOAT ) < 3.1 || $this->version( 'iPod', self::VERSION_TYPE_FLOAT ) < 3.1 || $this->is( 'Blackberry' ) && $this->version( 'BlackBerry', self::VERSION_TYPE_FLOAT ) >= 5 && $this->version( 'BlackBerry', self::VERSION_TYPE_FLOAT ) < 6 || $this->version( 'Opera Mini', self::VERSION_TYPE_FLOAT ) >= 5.0 && $this->version( 'Opera Mini', self::VERSION_TYPE_FLOAT ) <= 6.5 && ($this->version( 'Android', self::VERSION_TYPE_FLOAT ) >= 2.3 || $this->is( 'iOS' )) || $this->match( 'NokiaN8|NokiaC7|N97.*Series60|Symbian/3' ) || $this->version( 'Opera Mobi', self::VERSION_TYPE_FLOAT ) >= 11 && $this->is( 'SymbianOS' ) ) {
            return self::MOBILE_GRADE_B;
        }
        if ( $this->version( 'BlackBerry', self::VERSION_TYPE_FLOAT ) < 5.0 || $this->match( 'MSIEMobile|Windows CE.*Mobile' ) || $this->version( 'Windows Mobile', self::VERSION_TYPE_FLOAT ) <= 5.2 ) {
