				...
				if ( $current_tax && $taxonomy == $current_tax ) {
					...
					$js = "
						...
						jQuery('#dropdown_layered_nav_$taxonomy_filter').change(function(){
							...
							location.href = '" . esc_url_raw( add_query_arg('filtering', '1', remove_query_arg( 'filter_product_brand' ) ) ). "&filter_product_brand=' + jQuery('#dropdown_layered_nav_$taxonomy_filter').val();
